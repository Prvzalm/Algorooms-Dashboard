              ...
              <input
                ...
                onChange={() => {
                  setValue(
                    ...
                    chartTypeCombinedOrOption === "combined" ? null : "combined",
                    {
                      shouldDirty: true,
                    }
                  );
            ...
            <label className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
              <input
                ...
                onChange={() => {
                  setValue(
                    "chartTypeCombinedOrOption",
                    chartTypeCombinedOrOption === "options" ? null : "options",
                    {
                      shouldDirty: true,
                    }
                  );
